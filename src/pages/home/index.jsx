...
export function Home() {
  ...
  return (
    <div className={
      ...
      : 
      `font-['Roboto'] md:bg-[url('/assets/Desktop-diurno.png')] bg-[url('src/pages/home/assets/Mobile-diurno.png')] bg-cover flex flex-col gap-4 items-center pt-12 pb-7 md:px-[426px] px-5 transition-all`
    }>
